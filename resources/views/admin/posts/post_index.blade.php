			...
			<h3>
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						<li>
							<a href="{{ url('admin/posts/export/csv') }}">CSV</a>
						</li>
						<li>
							<a href="{{ url('admin/posts/export/json') }}">JSON</a>
						</li>
						<li>
							<a href="{{ url('admin/posts/export/pdf') }}">PDF</a>
						</li>
					</ul>
				</div>
				<div class="pull-right">
					<a href="{{ url('admin/posts/create') }}" class="btn btn-small btn-info"><span class="glyphicon glyphicon-plus-sign"></span> Create New Post</a>
				</div>
				<br>
			</h3>
		</div>	
	...
	<div class="col-xs-12">
		<div class="box">
            <div class="box-header">
              	<h3 class="box-title">Blog Posts List</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                  		...
                  		@if( !empty( $data ) )
                  			@foreach( $data as $item )
                  				<tr id="{{ $item->id }}">
				                    ...
				                    <td>
				                    	<a href="{{{ url('admin/posts/'.$item->id.'/edit' ) }}}" class="btn btn-sm btn-info btn-editable" >Edit</a>
	                                    @if( $item->enabled )
