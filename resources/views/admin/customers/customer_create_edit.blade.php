    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <form class="form-horizontal" method="post" action='{{ $mode =='edit' ? url('admin/customers/update/'.$user->id) : url('admin/customers/create/') }}'>
                    {!! csrf_field() !!}                      
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <input type="submit" class="btn btn-info pull-right" name="submit" value="{{$mode=='edit' ? 'Create':'Update'}}" />
                    </div><!-- /.box-footer -->
                </form>
            </div><!-- /.box -->
        </div><!-- /.col -->
