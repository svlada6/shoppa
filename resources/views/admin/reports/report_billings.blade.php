			...
			<h3>
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						<li>
							<a href="{{ url('admin/reports/export_orders_billing_addresses/csv') }}">CSV</a>
						</li>
						<li>
							<a href="{{ url('admin/reports/export_orders_billing_addresses/json') }}">JSON</a>
						</li>
						<li>
							<a href="{{ url('admin/reports/export_orders_billing_addresses/pdf') }}">PDF</a>
						</li>
					</ul>
				</div>
	...
	<div class="col-xs-12">
		<div class="box">
            <div class="box-header">
              	<h3 class="box-title">Billing address reports</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
