...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('site.products.index', compact('products', 'packages'));

        // Stus code
        // $user = Auth::User();
        // return view('site.products.index',compact('user'));
    }
    ...
    {
        Cart::destroy();
        return view('site.products.step1');
    }
    ...
    public function getStepPackages()
    {
        ...
        return view('site.products.step2', compact('products', 'packages', 'cart_data', 'total_in_cart'));
    }
    ...
    public function getStepBilling()
    {
        ...
        return view('site.products.step3', compact('cart_data', 'states','billing','shipping'));
    }
    ...
    {
        $data = Product::where('enabled', '=', '1')->where('slug', '=', $slug)->first();

        if( $data )
            return view('site.products.product', compact('data'));
        else
            return redirect('/');
    }
